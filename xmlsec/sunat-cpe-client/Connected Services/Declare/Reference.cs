...
namespace CPE.Client.Declare {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://service.sunat.gob.pe", ConfigurationName="Declare.billService")]
    public interface billService {
        ...
        CPE.Client.Declare.getStatusResponse getStatus(CPE.Client.Declare.getStatusRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:getStatus", ReplyAction="*")]
        System.Threading.Tasks.Task<CPE.Client.Declare.getStatusResponse> getStatusAsync(CPE.Client.Declare.getStatusRequest request);
        ...
        CPE.Client.Declare.sendBillResponse sendBill(CPE.Client.Declare.sendBillRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendBill", ReplyAction="*")]
        System.Threading.Tasks.Task<CPE.Client.Declare.sendBillResponse> sendBillAsync(CPE.Client.Declare.sendBillRequest request);
        ...
        CPE.Client.Declare.sendPackResponse sendPack(CPE.Client.Declare.sendPackRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendPack", ReplyAction="*")]
        System.Threading.Tasks.Task<CPE.Client.Declare.sendPackResponse> sendPackAsync(CPE.Client.Declare.sendPackRequest request);
        
        // CODEGEN: El parámetro 'ticket' requiere información adicional de esquema que no se puede capturar con el modo de parámetros. El atributo específico es 'System.Xml.Serialization.XmlElementAttribute'.
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [return: System.ServiceModel.MessageParameterAttribute(Name="ticket")]
        CPE.Client.Declare.sendSummaryResponse sendSummary(CPE.Client.Declare.sendSummaryRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        System.Threading.Tasks.Task<CPE.Client.Declare.sendSummaryResponse> sendSummaryAsync(CPE.Client.Declare.sendSummaryRequest request);
    }
    ...
    public partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public CPE.Client.Declare.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(CPE.Client.Declare.statusResponse status) {
            this.status = status;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface billServiceChannel : CPE.Client.Declare.billService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<CPE.Client.Declare.billService>, CPE.Client.Declare.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CPE.Client.Declare.getStatusResponse CPE.Client.Declare.billService.getStatus(CPE.Client.Declare.getStatusRequest request) {
            return base.Channel.getStatus(request);
        }
        
        public CPE.Client.Declare.statusResponse getStatus(string ticket) {
            CPE.Client.Declare.getStatusRequest inValue = new CPE.Client.Declare.getStatusRequest();
            inValue.ticket = ticket;
            CPE.Client.Declare.getStatusResponse retVal = ((CPE.Client.Declare.billService)(this)).getStatus(inValue);
            return retVal.status;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CPE.Client.Declare.getStatusResponse> CPE.Client.Declare.billService.getStatusAsync(CPE.Client.Declare.getStatusRequest request) {
            return base.Channel.getStatusAsync(request);
        }
        
        public System.Threading.Tasks.Task<CPE.Client.Declare.getStatusResponse> getStatusAsync(string ticket) {
            CPE.Client.Declare.getStatusRequest inValue = new CPE.Client.Declare.getStatusRequest();
            inValue.ticket = ticket;
            return ((CPE.Client.Declare.billService)(this)).getStatusAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CPE.Client.Declare.sendBillResponse CPE.Client.Declare.billService.sendBill(CPE.Client.Declare.sendBillRequest request) {
            return base.Channel.sendBill(request);
        }
        
        public byte[] sendBill(string fileName, byte[] contentFile) {
            CPE.Client.Declare.sendBillRequest inValue = new CPE.Client.Declare.sendBillRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            CPE.Client.Declare.sendBillResponse retVal = ((CPE.Client.Declare.billService)(this)).sendBill(inValue);
            return retVal.applicationResponse;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CPE.Client.Declare.sendBillResponse> CPE.Client.Declare.billService.sendBillAsync(CPE.Client.Declare.sendBillRequest request) {
            return base.Channel.sendBillAsync(request);
        }
        
        public System.Threading.Tasks.Task<CPE.Client.Declare.sendBillResponse> sendBillAsync(string fileName, byte[] contentFile) {
            CPE.Client.Declare.sendBillRequest inValue = new CPE.Client.Declare.sendBillRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            return ((CPE.Client.Declare.billService)(this)).sendBillAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CPE.Client.Declare.sendPackResponse CPE.Client.Declare.billService.sendPack(CPE.Client.Declare.sendPackRequest request) {
            return base.Channel.sendPack(request);
        }
        
        public string sendPack(string fileName, byte[] contentFile) {
            CPE.Client.Declare.sendPackRequest inValue = new CPE.Client.Declare.sendPackRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            CPE.Client.Declare.sendPackResponse retVal = ((CPE.Client.Declare.billService)(this)).sendPack(inValue);
            return retVal.ticket;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CPE.Client.Declare.sendPackResponse> CPE.Client.Declare.billService.sendPackAsync(CPE.Client.Declare.sendPackRequest request) {
            return base.Channel.sendPackAsync(request);
        }
        
        public System.Threading.Tasks.Task<CPE.Client.Declare.sendPackResponse> sendPackAsync(string fileName, byte[] contentFile) {
            CPE.Client.Declare.sendPackRequest inValue = new CPE.Client.Declare.sendPackRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            return ((CPE.Client.Declare.billService)(this)).sendPackAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CPE.Client.Declare.sendSummaryResponse CPE.Client.Declare.billService.sendSummary(CPE.Client.Declare.sendSummaryRequest request) {
            return base.Channel.sendSummary(request);
        }
        
        public string sendSummary(string fileName, byte[] contentFile) {
            CPE.Client.Declare.sendSummaryRequest inValue = new CPE.Client.Declare.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            CPE.Client.Declare.sendSummaryResponse retVal = ((CPE.Client.Declare.billService)(this)).sendSummary(inValue);
            return retVal.ticket;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CPE.Client.Declare.sendSummaryResponse> CPE.Client.Declare.billService.sendSummaryAsync(CPE.Client.Declare.sendSummaryRequest request) {
            return base.Channel.sendSummaryAsync(request);
        }
        
        public System.Threading.Tasks.Task<CPE.Client.Declare.sendSummaryResponse> sendSummaryAsync(string fileName, byte[] contentFile) {
            CPE.Client.Declare.sendSummaryRequest inValue = new CPE.Client.Declare.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            return ((CPE.Client.Declare.billService)(this)).sendSummaryAsync(inValue);
        }
    }
}
