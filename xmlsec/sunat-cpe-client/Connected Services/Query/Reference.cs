...
namespace CPE.Client.Query {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://service.sunat.gob.pe", ConfigurationName="Query.billService")]
    public interface billService {
        ...
        CPE.Client.Query.getStatusResponse getStatus(CPE.Client.Query.getStatusRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:getStatus", ReplyAction="*")]
        System.Threading.Tasks.Task<CPE.Client.Query.getStatusResponse> getStatusAsync(CPE.Client.Query.getStatusRequest request);
        ...
        CPE.Client.Query.getStatusCdrResponse getStatusCdr(CPE.Client.Query.getStatusCdrRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:getStatusCdr", ReplyAction="*")]
        System.Threading.Tasks.Task<CPE.Client.Query.getStatusCdrResponse> getStatusCdrAsync(CPE.Client.Query.getStatusCdrRequest request);
    }
    ...
    public partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public CPE.Client.Query.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(CPE.Client.Query.statusResponse status) {
            this.status = status;
        }
    }
    ...
    public partial class getStatusCdrResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public CPE.Client.Query.statusResponse statusCdr;
        
        public getStatusCdrResponse() {
        }
        
        public getStatusCdrResponse(CPE.Client.Query.statusResponse statusCdr) {
            this.statusCdr = statusCdr;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface billServiceChannel : CPE.Client.Query.billService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<CPE.Client.Query.billService>, CPE.Client.Query.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CPE.Client.Query.getStatusResponse CPE.Client.Query.billService.getStatus(CPE.Client.Query.getStatusRequest request) {
            return base.Channel.getStatus(request);
        }
        
        public CPE.Client.Query.statusResponse getStatus(string rucComprobante, string tipoComprobante, string serieComprobante, int numeroComprobante) {
            CPE.Client.Query.getStatusRequest inValue = new CPE.Client.Query.getStatusRequest();
            ...
            CPE.Client.Query.getStatusResponse retVal = ((CPE.Client.Query.billService)(this)).getStatus(inValue);
            return retVal.status;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CPE.Client.Query.getStatusResponse> CPE.Client.Query.billService.getStatusAsync(CPE.Client.Query.getStatusRequest request) {
            return base.Channel.getStatusAsync(request);
        }
        
        public System.Threading.Tasks.Task<CPE.Client.Query.getStatusResponse> getStatusAsync(string rucComprobante, string tipoComprobante, string serieComprobante, int numeroComprobante) {
            CPE.Client.Query.getStatusRequest inValue = new CPE.Client.Query.getStatusRequest();
            inValue.rucComprobante = rucComprobante;
            inValue.tipoComprobante = tipoComprobante;
            inValue.serieComprobante = serieComprobante;
            inValue.numeroComprobante = numeroComprobante;
            return ((CPE.Client.Query.billService)(this)).getStatusAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CPE.Client.Query.getStatusCdrResponse CPE.Client.Query.billService.getStatusCdr(CPE.Client.Query.getStatusCdrRequest request) {
            return base.Channel.getStatusCdr(request);
        }
        
        public CPE.Client.Query.statusResponse getStatusCdr(string rucComprobante, string tipoComprobante, string serieComprobante, int numeroComprobante) {
            CPE.Client.Query.getStatusCdrRequest inValue = new CPE.Client.Query.getStatusCdrRequest();
            inValue.rucComprobante = rucComprobante;
            inValue.tipoComprobante = tipoComprobante;
            inValue.serieComprobante = serieComprobante;
            inValue.numeroComprobante = numeroComprobante;
            CPE.Client.Query.getStatusCdrResponse retVal = ((CPE.Client.Query.billService)(this)).getStatusCdr(inValue);
            return retVal.statusCdr;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CPE.Client.Query.getStatusCdrResponse> CPE.Client.Query.billService.getStatusCdrAsync(CPE.Client.Query.getStatusCdrRequest request) {
            return base.Channel.getStatusCdrAsync(request);
        }
        
        public System.Threading.Tasks.Task<CPE.Client.Query.getStatusCdrResponse> getStatusCdrAsync(string rucComprobante, string tipoComprobante, string serieComprobante, int numeroComprobante) {
            CPE.Client.Query.getStatusCdrRequest inValue = new CPE.Client.Query.getStatusCdrRequest();
            inValue.rucComprobante = rucComprobante;
            inValue.tipoComprobante = tipoComprobante;
            inValue.serieComprobante = serieComprobante;
            inValue.numeroComprobante = numeroComprobante;
            return ((CPE.Client.Query.billService)(this)).getStatusCdrAsync(inValue);
        }
    }
}
